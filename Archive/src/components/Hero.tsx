            ...
            <form action="#" method="POST" className="flex flex-col gap-5">
              <div className="space-y-4">
                <div className="relative group">
                  ...
                  <input type="text" className="w-full py-3 pl-11 pr-4 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl text-gray-900 dark:text-white text-sm font-medium outline-none transition-all duration-200 placeholder:text-gray-400 focus:bg-white dark:focus:bg-[#0B1121] focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10" placeholder="Full Name" required />
                </div>
                ...
                <div className="relative group">
                  ...
                  <input type="email" className="w-full py-3 pl-11 pr-4 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl text-gray-900 dark:text-white text-sm font-medium outline-none transition-all duration-200 placeholder:text-gray-400 focus:bg-white dark:focus:bg-[#0B1121] focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10" placeholder="Work Email" required />
                </div>
                ...
                <div className="relative group">
                  ...
                  <input type="tel" className="w-full py-3 pl-11 pr-4 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl text-gray-900 dark:text-white text-sm font-medium outline-none transition-all duration-200 placeholder:text-gray-400 focus:bg-white dark:focus:bg-[#0B1121] focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10" placeholder="Phone Number" required />
                </div>
